...
async function hentJson() {
    ...
    document.querySelector("[data-tekst6]").innerHTML = omos.acf.tekst6;
    document.querySelector("[data-tekst7]").innerHTML = omos.acf.tekst7;

    document.querySelector("[data-img6]").src = omos.acf.img6.url;
